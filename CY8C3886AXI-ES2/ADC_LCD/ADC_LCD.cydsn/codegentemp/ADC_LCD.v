// ======================================================================
// ADC_LCD.v generated from TopDesign.cysch
// 08/28/2015 at 10:18
// ======================================================================
...
module ADC_DelSig_v2_20_2 (vplus, vminus, soc, eoc, aclk, nVref);
	...
	cy_clock_v1_0
		#(.id("f4581dc6-c9d6-40b2-9af0-7985846e130f/b7604721-db56-4477-98c2-8fae77869066"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("976562500"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("f4581dc6-c9d6-40b2-9af0-7985846e130f/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("3906250000"),
		  .is_direct(0),
...
module CharLCD_v1_50_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b3b7ebbb-2ca2-4e8e-8f2b-90284a322527/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module Comp_v1_70_4 (Vplus, CmpOut, Vminus, clock);
    inout   Vplus;
    electrical   Vplus;
    output  CmpOut;
    inout   Vminus;
...
module CapSense_CSD_v3_10_5 (clock, shield, vref, bclk);
	...
	cy_clock_v1_0
		#(.id("ed10e326-e165-4d00-8507-e0aaaccc6714/0ad1a1a8-974e-43a0-841b-3af08590011d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_port_v1_0
		#(.width(2),
		  .siorefwidth(1),
		  .id("ed10e326-e165-4d00-8507-e0aaaccc6714/dd9c1af8-be5a-4b9e-b10c-b2d9f11dc9fc"),
		  .pin_aliases({"Button0__BTN,But","ton1__BTN"}),
		  .access_mode("HW_ONLY"),
		  .layout_mode("NONCONTIGUOUS"),
		  .port_mode("ANALOG"),
		  .intr_mode(4'b0000),
		  .drive_mode(6'b100100),
		  .por_state(0),
		  .enable_shielding(2'b00),
		  .cs_mode(2'b11))
		PortCH0
	...
	cy_psoc3_pins_v1_10
		#(.id("ed10e326-e165-4d00-8507-e0aaaccc6714/232398c5-3876-4e07-8f5b-7cd7657055e2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
    ...
    defparam AMuxCH0.muxin_width = 5;
    defparam AMuxCH0.init_mux_sel = 5'h0;
	...
	cy_clock_v1_0
		#(.id("ed10e326-e165-4d00-8507-e0aaaccc6714/96e8b2d4-d8ed-4ea5-8793-7587f4b4bf01"),
...
// PWM_v2_10(CaptureMode=0, CompareStatusEdgeSense=true, CompareType1=5, CompareType1Software=1, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CtlModeReplacementString=AsyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=10000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_nrstSts, RunMode=0, TriggerMode=0, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_COMPONENT_NAME=PWM_v2_10, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=PWM_1, )
module PWM_v2_10_6 (pwm2, tc, clock, reset, pwm1, interrupt, capture, kill, enable, trigger, cmp_sel, pwm, ph1, ph2);
    output  pwm2;
    output  tc;
    input   clock;
    input   reset;
...
module top ;
	...
	cy_clock_v1_0
		#(.id("ea553179-ff3b-41b4-9c94-8357d38485ab"),
	...
	wire [0:0] tmpOE__COLD_net;
	wire [0:0] tmpFB_0__COLD_net;
	wire [0:0] tmpIO_0__COLD_net;
	wire [0:0] tmpINTERRUPT_0__COLD_net;
	electrical [0:0] tmpSIOVREF__COLD_net;
	...
	cy_psoc3_pins_v1_10
		...
		COLD
		 (.oe(tmpOE__COLD_net),
		  .y({Net_99}),
		  .fb({tmpFB_0__COLD_net[0:0]}),
		  .io({tmpIO_0__COLD_net[0:0]}),
		  .siovref(tmpSIOVREF__COLD_net),
		  .interrupt({tmpINTERRUPT_0__COLD_net[0:0]}));

	assign tmpOE__COLD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
