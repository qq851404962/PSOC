...
#define LCD_Char_1_CUSTOM_CHAR_SET         (1u)

/* Custom character set types */
#define LCD_Char_1_NONE                     (0u)    /* No Custom Fonts      */
#define LCD_Char_1_VERTICAL_BG              (1u)    /* Horizontal Bar Graph */
#define LCD_Char_1_HORIZONTAL_BG            (2u)    /* Vertical Bar Graph   */
...
#if((LCD_Char_1_CUSTOM_CHAR_SET == LCD_Char_1_VERTICAL_BG) || (LCD_Char_1_CUSTOM_CHAR_SET == LCD_Char_1_HORIZONTAL_BG))
